...
- share one runtime-backed session launch layer across TUI and non-interactive surfaces so `start`, `resume`, and `continue` resolve and execute through the same contract
