...
- share one runtime-backed session launch planner across TUI and non-interactive surfaces so `start`, `resume`, and `continue` resolve through the same contract
